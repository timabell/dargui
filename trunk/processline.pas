...
{ this unit is a slightly modified version of PasDoc_ProcessLineTalk.pas from http://pasdoc.sourceforge.net/ }
...
type
 ...
 { StreamWriteLine copied from StreamUtils.pas (PasDoc) }
